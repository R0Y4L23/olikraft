...
import { View,Text,Image,TouchableOpacity , TextInput,StyleSheet,ScrollView,Dimensions} from 'react-native';
...
export default function Forgotpass ({navigation}) {
    ...
    return (
        ...
        <View style={{alignItems:"center",backgroundColor:"rgb(249,249,249)",flex:1,justifyContent:"space-evenly"}}>
            <View style={{width:"100%",flex:8,justifyContent:"flex-start"}}>
          ...
          <View style={{flex:15}}>
            ...
            <View style={{width:"100%",flex:1,justifyContent:"space-evenly",alignItems:"center",marginTop:10}}>
              ...
              <TextInput  style={{ height: 50,borderColor:"grey",borderWidth:0.5,borderRadius:10,backgroundColor:"white",width:"90%",paddingLeft:20,marginTop:30}} placeholder="Enter Email" onChangeText={setEmail} value={email}/>
            </View>
            </ScrollView>
            </View>
