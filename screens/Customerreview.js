...
const RecentReviewsComponent=({name,stars,comment,url})=>{
    ...
    return (
        <View style={{width:"100%",height:140,borderBottomWidth:0.5,marginVertical:0.5,borderColor:"grey",backgroundColor:"rgb(249,249,249)",backgroundColor:"white",shadowColor: 'rgba(0, 0, 0, 0.2)',shadowOpacity: 1.5,shadowRadius: 20,elevation:5,display:"flex",flexDirection:"row",justifyContent:"space-around"}}>
            <View >
