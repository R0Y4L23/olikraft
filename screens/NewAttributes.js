                            ...
                            <View key={idx}>
                                    ...
                                    <View style={{flexDirection:"row",marginVertical:5,marginHorizontal:15}}>
                                {
                                    att.options.map((option,index)=>{
                                        return(
                                            <NewButtons option={option} index={index} title={att.name} len={Attributes.length} fa={fa} key={index} images={Images} match={match} titles={titles} opt={opt} pid={id} uid={updateid} />
