...
const Tutorials = ({navigation}) => {
    return (
        <View style={{backgroundColor:"#f9f9f9"}}>
            ...
            <Text style={{color:"rgb(5,23,41)",fontSize:24}}>Yarn Wilner (with Umbrella Swift) Setup Guid</Text>
            ...
            <Text style={{color:"grey",fontSize:15,marginTop:8}}>With you, our customers being one of our top priorities. We have specially put together video tutorials to aid you in using our products the best ways possible!</Text>
